...
const InteractionModal: React.FC<InteractionModalProps> = ({ interactiveObject, step, onClose, onComplete, isAnimating = false }) => {
    ...
    return (
        ...
        >
            <div className={`bg-gray-800 text-white rounded-lg shadow-2xl border-2 border-blue-400 w-full max-w-7xl max-h-[95vh] transform transition-all relative flex flex-col ${isAnimating ? 'animate-modal-slide-up' : 'animate-fade-in-up'
                }`}>
